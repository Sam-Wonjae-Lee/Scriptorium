...
const LANGUAGES: string[] = ["py", "cpp", "c", "java", "js", "php", "R", "rb", "cs", "rs"];
// 10 seconds
...
async function executeCode(req: { body: RequestBody }, identifier: string): Promise<ExecuteResult> {
  let executableArgs: string | undefined;
  let execProgram : string = "";
