    ...
    <div className="w-full">
        ...
        <nav className="fixed top-0 left-0 right-0 flex items-center justify-between h-14 px-4 bg-light_pink-darken border-b z-10">
            ...
            <div className="flex-1 max-w-2xl mx-4">
              <div className="flex">
                <div className="flex flex-1 items-center border rounded-l-full px-4 bg-gray-50">
                  <input
                    type="text"
                    placeholder="Search"
                    value={searchQuery}
                ...
                <button className="px-6 bg-gray-100 border-l-0 border rounded-r-full hover:bg-gray-200">
        ...
        {/* Side Bar */}
        {isSideBarOpen && (
          <div className="fixed left-0 top-14 h-full w-64 bg-white border-r shadow-lg z-20">
              <div className="p-4">
              <a href="/" className="flex items-center px-4 py-3 hover:bg-light_pink-darken">
                <svg className="h-6 w-6 mr-3" stroke="currentColor" fill="none" viewBox="0 0 24 24">
