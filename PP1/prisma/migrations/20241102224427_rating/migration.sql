...
INSERT INTO "new_Blogs" ("authorId", "content", "id", "isFlagged", "numReports", "title") SELECT "authorId", "content", "id", "isFlagged", "numReports", "title" FROM "Blogs";
DROP TABLE "Blogs";
...
INSERT INTO "new_Comments" ("blogId", "content", "id", "isFlagged", "numReports", "parentCommentid", "userId") SELECT "blogId", "content", "id", "isFlagged", "numReports", "parentCommentid", "userId" FROM "Comments";
DROP TABLE "Comments";
